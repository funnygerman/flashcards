/**
 * A deck page, assembled: the library, review scheduling, session selection and
 * the way out, wired together the way every deck wires them.
 *
...
/**
 * Mount a deck that keeps a schedule. Returns the library's handle.
 *
 ...
 */
export function study(element, cards, options = {}) {
  const { corner, storage, random, now } = options;
